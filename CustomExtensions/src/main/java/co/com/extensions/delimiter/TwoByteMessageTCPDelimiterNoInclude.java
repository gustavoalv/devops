 ...
 *
 */
public class TwoByteMessageTCPDelimiterNoInclude implements TCPDelimiter{
    
    private static Logger log = Logger.getLogger(TwoByteMessageTCPDelimiterNoInclude.class);
    ...
    public boolean locateRequest(List<Byte> bytes) {
        if (!bytes.isEmpty()) {
            ...
            // No Se inlcuyen los dos bytes de la longitud del mensaje
